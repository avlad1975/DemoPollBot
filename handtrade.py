...
def start_message():  # запуск страртового сообщения
    ...
    text_message = '<b>Коллективный трейдинг в 18:ОО - 19:ОО по МСК 🎯</b>\n'
    text_message = text_message + '\n<i>Правила торговли на открытой торговой сессии трейдеров: </i>\n'
    text_message = text_message + '<i>1.</i> <b>Вход в рынок всегда фиксированный на 5 минут ⏲</b>\n'
    text_message = text_message + '<i>2.</i> <b>Время опроса с момента публикации валютной пары 6О сек ⌚</b>\n'
    text_message = text_message + '<i>3.</i> <b>Торговля с трейдерами служит в качестве ПРАКТИКИ анализа ' \
                                  'графика 📊</b>\n'
    text_message = text_message + '<i>4.</i> <b>Это НЕ сигналы, это НЕ кнопка бабло, это НЕ грааль ❌</b>\n'
    text_message = text_message + '<i>5.</i> <b>Используйте торговлю с трейдерами для ОБУЧЕНИЯ анализа графика 📚</b>\n'
    text_message = text_message + '\nПомните, что это практика торговли, Вы проводите анализ графика, и еще 1ОО+ ' \
                                  'человек проводят анализ вместе с Вами, мнение могут, и будут расходится! ' \
                                  'Алгоритм фиксирует вход отталкиваясь от мнения большинства трейдеров, НО, ' \
                                  'это не значит, что прогноз будет успешен в 1ОО% случаев. Всегда подключайте ' \
                                  'свою голову, и поставьте себе цель в этой торговле, обучиться анализу графику, ' \
                                  'а не надеяться, что другие трейдеры правы и благодаря им Вы обогатитесь ❗\n'
    text_message = text_message + '\n<b>Прогнозы выдаёт НЕ робот, НЕ Smoke FX, НЕ Лев ☝️Каждый прогноз это результат ' \
                                  'голосования, где учитываются мнения 1ОО+ трейдеров, аминь 👍</b>\n'
